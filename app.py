...
def main():
    ...
    if classifier == "Support Vector Machine (SVM)":
        ...
        if st.sidebar.button("Classify", key="classify"):
            ...
            st.write("Precision: ", (precision_score(y_test, y_pred, labels=class_names).round(2))*100, "%")
            st.write("Recall: ", (recall_score(y_test, y_pred, labels=class_names).round(2))*100, "%")
